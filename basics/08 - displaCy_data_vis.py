...
# with open('/home/samhakem/PycharmProjects/spacy_lab/basics/data/alice.txt', 'r') as f:  # Remove line breaks and
# double line breaks to allow small 'model to accurately read in sentences with \n
# text: object = f.read().replace('\n\n', ' ').replace('\n', ' ')
